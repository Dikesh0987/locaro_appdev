                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            SlidePageRoute(
                              page: ProductDetailsScreen(productId: p.id),
                            ),
                          );
                        },
                        child: SizedBox(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            SlidePageRoute(
                              page: ShopProfileScreen(shopId: s.id),
                            ),
                          );
                        },
                        child: SizedBox(
                    ...
                    child: BaseCard(
                      onTap: () {
                        Navigator.push(
                          context,
                          SlidePageRoute(
                            page: ShopProfileScreen(shopId: shop.id),
                          ),
                        );
                      },
                      child: Padding(
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        separatorBuilder: (context, index) =>
            const SizedBox(width: AppSpacing.s16),
        itemBuilder: (context, index) {
          return const SizedBox(width: 140, child: ProductSkeletonCard());
        },
      ),
    );
  }
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        separatorBuilder: (context, index) =>
            const SizedBox(width: AppSpacing.s16),
        itemBuilder: (context, index) {
          return const SizedBox(width: 200, child: ShopCardSkeleton());
        },
      ),
    );
  }
